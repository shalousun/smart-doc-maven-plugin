...
import io.github.smartdoc.builder.javadoc.JavadocHtmlBuilder;
...
@Mojo(name = MojoConstants.JAVADOC_HTML_MOJO, requiresDependencyResolution = ResolutionScope.COMPILE)
public class JavadocHtmlMojo extends BaseDocsGeneratorMojo {
