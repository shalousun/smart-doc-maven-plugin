...
import io.github.smartdoc.builder.grpc.GrpcAsciidocBuilder;
...
@Mojo(name = MojoConstants.GRPC_ADOC_MOJO, requiresDependencyResolution = ResolutionScope.COMPILE)
public class GrpcAdocMojo extends BaseDocsGeneratorMojo {
