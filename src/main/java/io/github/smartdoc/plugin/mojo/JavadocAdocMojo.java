...
import io.github.smartdoc.builder.javadoc.JavadocAdocBuilder;
...
@Mojo(name = MojoConstants.JAVADOC_ADOC_MOJO, requiresDependencyResolution = ResolutionScope.COMPILE)
public class JavadocAdocMojo extends BaseDocsGeneratorMojo {
